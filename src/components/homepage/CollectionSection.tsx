...
const CollectionSection: React.FC = () => {
    return (
        <div className='grid place-items-center mt-[96px]'>
            <div className='grid grid-cols-2 gap-4 items-center'>
                <div className='w-[675.56px] h-[658.12px] bg-[#F1F1F1] pl-[88px] py-auto flex items-center justify-start'>
                    <div className='jost-font '>
                        <h2 className=' font-bold text-[33.52px] text-[#616161]'>BYC Collection 2021</h2>
                        <h4 className=' font-bold text-[52.43px]'>BYC Collection</h4>
                        ...
                        <div className='mt-20'><ExploreCollectionButton /></div>
                    </div>
                </div>
                <div className='w-[675.56px] h-[658.12px]'>
