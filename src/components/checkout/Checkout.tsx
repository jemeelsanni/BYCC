...
const Checkout: React.FC = () => {
    ...
    return (
        <div className="mt-24 mx-24">
            <div className='border-[#F1EEEE] border shadow-lg rounded-lg p-9 pb-[75px] mt-[65px] manrope-font'>
                <div>
                    ...
                    <div className=' flex items-start justify-between'>
                            ...
                            <div>
                                <div className='mb-[34px]'>
                                    <h3 className=' font-bold text-[26px] mb-[16px]'>MEN BOXERS <br />
                                        BYC 1166</h3>
                                    <p className=' font-normal text-[20px]'>100% Cotton 12 Pieces Of Mens Boxer </p>
                                </div>
                                <div className='mb-[15px]'><p className='font-bold text-[30px]'>₦2,800.00</p></div>
                        ...
                        <div className='flex'>
                            <div className='border-l-2 border-[#F1EEEE] h-[196px] mr-5'></div>
                            <div className=''>
                                ...
                                <div className="flex justify-between mt-[23px] pb-[38px] border-b-2 border-[#F1EEEE]">
                ...
                <div className='flex items-start justify-center mt-[60px]'>
                    ...
                    <div className='w-[50]%'>
                        <div className='mb-4'><h3 className=' manrope-font font-bold text-[27px] ml-[82px]'>CHECKOUT</h3></div>
                        <div className='w-full border-b-2 border-[#F1EEEE] mb-[24px]'></div>
                        <div className='ml-[82px] bg-[#FFF8F8] px-[24px] pt-[42px] pb-[50px] rounded-[10px]'>
                            ...
                            <div className='flex items-start cursor-pointer' onClick={() => setSelectedMethod('bank')}>
                                ...
                                <div className="">
                                    ...
                                    <p className="text-[14px] bg-[#FFFFFF] text-[#9F9F9F] rounded-[10px] py-4 pl-4 pr-16 mt-6 w-full">
                            ...
                            <div className='flex items-center cursor-pointer mt-10' onClick={() => setSelectedMethod('online')}>
                                <div
                                    className={
                                        `w-6 h-6 rounded-full border-2 mr-3 mt-1
                        ...
                        <button className='w-[674px] text-white bg-[#BD3A3A] rounded-[10px] font-normal text-[16px] mt-[39px] ml-[82px] p-4'>
                            Place Order
                        </button>
                    </div>
                </div>
